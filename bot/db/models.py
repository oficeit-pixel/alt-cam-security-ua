...
class WebOrder(Base):
    ...
    tracking_provider: Mapped[str | None] = mapped_column(String(32))
    telegram_username: Mapped[str | None] = mapped_column(String(64), index=True)
    drive_folder_url: Mapped[str | None] = mapped_column(String(500))
    supplier_order_number: Mapped[str | None] = mapped_column(String(120), index=True)
    problem_note: Mapped[str | None] = mapped_column(Text)
