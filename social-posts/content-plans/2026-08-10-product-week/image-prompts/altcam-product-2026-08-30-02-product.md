...
Text zones: leave clean space for headline “Контроль доступу — це не тільки зчитувач. Двері мають ще й правильно закриватися.”, short feature line, and bottom CTA “НАПИШІТЬ «ЗАМОК»”.
...
CTA: Напишіть «ЗАМОК» у Telegram або відкрийте https://alt-cam.net.ua
