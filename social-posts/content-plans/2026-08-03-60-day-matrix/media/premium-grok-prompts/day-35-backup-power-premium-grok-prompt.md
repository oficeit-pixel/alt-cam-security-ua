...
Scene:
блекаут у квартирі або приватному будинку, темна кімната з працюючим роутером, UPS/LiFePO4, Ajax і камери продовжують працювати

Main product / service:
резервне живлення для об’єкта “магазин”.
Brands to imply naturally where relevant: Ajax / UPS / LiFePO4. Do not place random third-party logos unless the product clearly belongs to that ecosystem.
...
- Роутер і ONU
- PoE/NVR
- Ajax і критичні датчики

Problem insight:
“Камери можуть мати живлення, але роутер або ONU вимикаються — і віддаленого доступу немає.”

Solution:
“Резервуємо весь ланцюг: камери, NVR, PoE, роутер, ONU, Ajax і критичні датчики. Адаптуємо під об’єкт: магазин.”

Specs:
“UPS або LiFePO4, розрахунок у Wh, захист АКБ, окрема лінія для мережевого обладнання.”

Price note:
“Базовий резерв для мережі та безпеки — орієнтир: від 8 900 ₴.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «РЕЗЕРВ»”
Small CTA subtext:
...
- realistic object in background: магазин;
