...
Solution:
“Рахуємо архів за кількістю камер, бітрейтом, режимом запису, роздільною здатністю і сценарієм об’єкта. Адаптуємо під об’єкт: кав’ярня.”
