...
Scene:
сучасний під’їзд ЖК, домофонна панель, електрозамок, камера, чиста навігація для мешканців

Main product / service:
ОСББ для об’єкта “приватний будинок”.
...
Solution:
“Робимо систему входу: домофон, зчитувач, доводчик, електрозамок, БЖ і зрозумілий доступ. Адаптуємо під об’єкт: приватний будинок.”

Specs:
“IP-домофон, зчитувач, електрозамок, доводчик, блок живлення, ключі/брелоки.”
