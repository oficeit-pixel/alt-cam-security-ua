...
Scene:
преміальна квартира, вхідні двері, Ajax Hub, датчики руху/відкриття, сирена, клавіатура, смартфон із додатком, усе в чорному мінімалістичному стилі

Main product / service:
Ajax для об’єкта “офіс”.
Brands to imply naturally where relevant: Ajax / Hikvision / Dahua / Uniview. Do not place random third-party logos unless the product clearly belongs to that ecosystem.
...
Solution:
“Поєднуємо сценарій Ajax, візуальну перевірку камерами, сирену, резерв і зрозумілу реакцію. Адаптуємо під об’єкт: офіс.”

Specs:
“Ajax Hub, MotionProtect/DoorProtect, сирена, IP-камери, NVR, UPS.”

Price note:
“Комплекс Ajax + відеоспостереження — орієнтир: від 34 900 ₴.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «AJAX»”
Small CTA subtext:
