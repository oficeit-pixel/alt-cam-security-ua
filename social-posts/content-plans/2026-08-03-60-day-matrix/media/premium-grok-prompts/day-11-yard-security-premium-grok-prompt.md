...
Scene:
двір приватного будинку, ворота, авто, периметр, камера на фасаді, тепле світло у вікнах, акцент на огляді території

Main product / service:
приватний будинок для об’єкта “квартира”.
...
Solution:
“Будуємо схему покриття за маршрутами руху: ворота, калитка, вхід, гараж, паркомісце. Адаптуємо під об’єкт: квартира.”

Specs:
“4–8 IP-камер, нічний режим, PoE, архів 14–30 днів, UPS.”

Price note:
“Відеоспостереження для двору — орієнтир: від 29 900 ₴.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «ДВІР»”
Small CTA subtext:
