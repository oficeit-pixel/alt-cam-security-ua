...
Scene:
повний комплект відеоспостереження на столі: 4 камери, NVR, HDD, PoE-комутатор, бухта кабелю, UPS, фон приватного будинку або офісу

Main product / service:
готовий комплект для об’єкта “виробництво”.
...
Solution:
“Рахуємо повний комплект під задачу, а не просто коробку з камерами. Адаптуємо під об’єкт: виробництво.”

Specs:
“4 IP-камери 4 Мп, NVR, HDD 2 ТБ, PoE, кабель, монтаж, смартфон, базовий інструктаж.”

Price note:
“Комплект з базовим монтажем — орієнтир: від 24 900 ₴.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «КОМПЛЕКТ»”
Small CTA subtext:
...
- realistic object in background: виробництво;
