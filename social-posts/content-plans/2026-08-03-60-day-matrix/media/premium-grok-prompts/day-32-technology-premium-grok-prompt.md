...
Scene:
нічний двір або парковка, порівняння звичайної нічної картинки і ColorVu/AcuSense/WizSense, камера крупним планом, чистий security-tech інтерфейс

Main product / service:
технології камер для об’єкта “офіс”.
Brands to imply naturally where relevant: Hikvision / Dahua. Do not place random third-party logos unless the product clearly belongs to that ecosystem.
...
Benefit list:
- ColorVu / AcuSense
- Розпізнавання людей/авто
- Краще нічне зображення
- Менше хибних тривог
...
Solution:
“Підбираємо технологію під сцену: ніч, рух людей/авто, засвіт, дальність, архів і бюджет. Адаптуємо під об’єкт: офіс.”

Specs:
“Hikvision ColorVu/AcuSense або Dahua WizSense, 4 Мп, PoE, архів 14–30 днів.”

Price note:
“Комплект на 4 камери з монтажем — орієнтовно від 24 900 ₴.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «КАМЕРА»”
Small CTA subtext:
...
- realistic object in background: офіс;
