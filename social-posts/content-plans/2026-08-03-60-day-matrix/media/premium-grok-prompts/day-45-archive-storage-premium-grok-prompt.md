...
Scene:
аккуратний серверний щит, NVR, HDD, PoE-комутатор, UPS, підписані кабелі, чистий технічний монтаж

Main product / service:
архів для об’єкта “магазин”.
...
Solution:
“Рахуємо архів за кількістю камер, бітрейтом, режимом запису, роздільною здатністю і сценарієм об’єкта. Адаптуємо під об’єкт: магазин.”

Specs:
“HDD 2–8 ТБ, H.265/H.265+, запис за рухом або постійно, NVR.”

Price note:
“Підбір архіву та диска — орієнтир: від 900 ₴; HDD додається окремо.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «АРХІВ»”
Small CTA subtext:
