...
Scene:
сучасні ворота приватного будинку або під’їзд, відеопанель домофона на стовпі, внутрішній монітор і смартфон з відеовикликом, людина на екрані

Main product / service:
домофонія для об’єкта “приватний будинок”.
Brands to imply naturally where relevant: Dahua / Hikvision / Imou. Do not place random third-party logos unless the product clearly belongs to that ecosystem.
...
- Відкриття дверей/хвіртки
- Запис фото та відео
- Інтеграція з електрозамком

Problem insight:
“Старий домофон шумить, не показує гостя або не дає відкрити хвіртку дистанційно.”

Solution:
“Ставимо IP-панель, монітор, електрозамок, живлення і налаштовуємо виклик на смартфон. Адаптуємо під об’єкт: приватний будинок.”

Specs:
“IP-домофон, виклична панель, монітор, електрозамок, блок живлення, резерв за потреби.”

Price note:
“Комплект домофонії з монтажем — від 18 900 ₴.”

CTA button:
“НАПИШІТЬ У ПОВІДОМЛЕННЯ «ДОМОФОН»”
Small CTA subtext:
...
- realistic object in background: приватний будинок;
