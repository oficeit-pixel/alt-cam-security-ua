...
INDEX_PATH = CALENDAR_DIR / "index.html"
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .platform-plan { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12px; margin: 0 0 20px; }
    .platform-card { border: 1px solid var(--line); border-radius: 18px; background: rgba(255,255,255,.04); padding: 14px; }
    .platform-card strong { display: block; color: var(--gold); margin-bottom: 6px; }
    .platform-card span { display: block; color: var(--muted); line-height: 1.45; font-size: 14px; }
    ...
    @media (max-width: 840px) {
      ...
      .platform-plan { grid-template-columns: 1fr; }
...
<body>
  <main>
    ...
    <section class="platform-plan" aria-label="План публикацій по соцмережах">
      ...
      <div class="platform-card"><strong>Instagram</strong><span>Карусель/Reels: обкладинка, 6 слайдів, хештеги, гео Київ / Вишгород / область.</span></div>
      <div class="platform-card"><strong>TikTok / Reels / Shorts</strong><span>Кричаща заставка + сценарій 0–30 сек: гачок, біль, рішення, вердикт, реклама.</span></div>
      <div class="platform-card"><strong>Telegram</strong><span>Розбір або акція з кнопкою на квиз/калькулятор: “Розрахувати вартість у боті”.</span></div>
      <div class="platform-card"><strong>Threads</strong><span>Короткі теми для обговорення: питання, міфи, помилки, заклик коментувати.</span></div>
      <div class="platform-card"><strong>YouTube</strong><span>Long + Community: SEO-назва, таймкоди, опис, закріплений коментар і обкладинка.</span></div>
    </section>
