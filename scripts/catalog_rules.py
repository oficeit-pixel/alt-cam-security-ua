...
GROUPS = {
    ...
    "energy_accessories": "Аксесуари для енергосистем",
    ...
    "installation_consumables": "Аксесуари та витратні матеріали для монтажу",
...
ALLOWED_CATEGORY_IDS = {
    ...
    "alternative_energy": {163, 192, 200, 204, 218, 263},
    "lithium_batteries": {237},
    "chargers": {138, 217},
    "energy_accessories": {194},
    "batteries": {47, 216},
    "emergency_power": {87, 88, 233},
    "power_adapters": {46, 139},
    "brackets_junction_boxes": {15, 24, 71, 200, 210, 266},
    "cable_products": {45, 239},
    "installation_consumables": {43, 44, 48, 219, 224, 240},
    "accessories": {24, 42, 46, 71, 217},
    "network_equipment": {49, 50, 51, 52, 58, 70, 77, 140, 159, 270},
    "electrical": {141, 171, 172, 193},
    "tools": {190, 196, 197},
}
